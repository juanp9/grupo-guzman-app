    ...
    >
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${OPERACION_STYLE[p.tipo_operacion]}`}>
            {OPERACION_LABEL[p.tipo_operacion]}
          </span>
          <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${ESTADO_STYLE[p.estado]}`}>
